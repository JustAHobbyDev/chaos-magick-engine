...
The selected founding demon is [The Heresiarch](design/004-founding-demon.md), a charismatic exegete who cultivates interpreters capable of surpassing it. Its seed defines its appetite for coven growth and loosh—attention and investment, devotion and tribute—and its repertoire of charisma, thematic clickbait, and creative workings. [The Confessor](design/013-the-confessor.md) is a proposed alternative founding demon, drafted after two live runs showed the Heresiarch's seed dissolving its own readings; it is not selected. [The house and its demons](design/014-the-house-and-its-demons.md) proposes the business the coven would sell to and four demon specializations for it.
